...
let apiComputerEasy: string = "https://opentdb.com/api.php?amount=10&category=18&difficulty=easy&type=multiple"
let apiComputerMedium: string = "https://opentdb.com/api.php?amount=20&category=18&difficulty=medium&type=multiple"
let apiComputerHard: string = "https://opentdb.com/api.php?amount=30&category=18&difficulty=hard&type=multiple"


let apiScienceEasy: string = "https://opentdb.com/api.php?amount=10&category=17&difficulty=easy&type=multiple"
let apiScienceMedium: string = "https://opentdb.com/api.php?amount=20&category=17&difficulty=medium&type=multiple"
let apiScienceHard: string = "https://opentdb.com/api.php?amount=30&category=17&difficulty=hard&type=multiple"


let apiGKEasy: string = "https://opentdb.com/api.php?amount=10&category=9&difficulty=easy&type=multiple"
let apiGKMedium: string = "https://opentdb.com/api.php?amount=20&category=9&difficulty=medium&type=multiple"
let apiGKHard: string = "https://opentdb.com/api.php?amount=30&category=9&difficulty=hard&type=multiple"
